...
TRAIN_DATASET = "../stratify_dataset/train_fold_0.json"
VAL_DATASET = "../stratify_dataset/val_fold_0.json"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=TRAIN_DATASET,  # train json 파일 경로
    ...
    val=dict(
        type=dataset_type,
        ann_file=VAL_DATASET,  # valid json 파일 경로
        img_prefix=data_root,
        classes=classes,
